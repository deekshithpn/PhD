...
ax.set_title("Learning evolution of Skw", fontsize=18, fontweight='bold')
...
plt.savefig('learning_2_skw.pdf', bbox_inches='tight')

torch.save(funcSkewness, '2_skewness.pth')
# Show the plot
# plt.show()
